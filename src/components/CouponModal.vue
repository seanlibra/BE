      ...
      <div class="coupon_modal" :class="{ active : modalStatus }">
          ...
          <div class="body">
              <div class="form-group mt-2">
                    ...
                    <input v-model="couponDetail.title" type="text" class="form-control" name=""  >
              </div>
              <div class="form-group mt-2">
              ...
              <div class="form-group mt-2">
                    ...
                    <input v-model.number="couponDetail.percent" min="0" max="100" type="number" class="form-control" name=""  >
              </div>
              <div class="form-group">
                    <label for="percent">折扣碼</label>
                    <input v-model="couponDetail.code" type="text" class="form-control" name=""  >
              </div>
                <div class="form-check">
                    <input v-model="couponDetail.is_enabled" :true-value="1" :false-value="0"  id="is_enabled" class="form-check-input" type="checkbox">
                    <label class="form-check-label" for="is_enabled">是否啟用</label>
                </div>
          </div>
          <div class="footer">
              <a @click.prevent="addCoupon" v-if="isnew" class="works_btn" href="#">新增</a>
              <a @click.prevent="updateCoupon" v-else class="works_btn" href="#">更新</a>
          </div>
      </div>
  </div>
</template>
