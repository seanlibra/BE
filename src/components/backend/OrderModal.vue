                           ...
                           <div class="order_block col-6">
                                ...
                                <div class="order_item_group">
                                    ...
                                    <div class="d-flex w-50">
                                        <input v-model="tempOrder.is_paid" type="checkbox" class="form-check-input">
                                        <span v-if="tempOrder.is_paid" class="text-success mx-2">已付款</span>
                            ...
                            <table class="order_product_list">
                                ...
                                <tbody>
                                    <tr v-for="item in tempOrder.products" :key="item.id">
                                        <td class="text-center"><img class="thumbnail" :src="item.product.imageUrl" alt=""></td>
                        ...
                        <div class="order_block col-6">
                            ...
                            <div class="order_item_group">
                              ...
                              <div class="order_item_group">
                                ...
                                <input v-model="tempOrder.user.message" class="form-control" type="text">
                            </div>
                        </div>
                    </div>
                </div>
...
export default {
  ...
  computed: {
    timeStamp: function () {
      var date = new Date(this.tempOrder.date)
...
<style scoped>
  ...
  .order_modal {
    ...
    .order_item_group label , .order_item_group span:nth-child(1)  {
        width: 40%;
    }
    .order_item_group input:not([type="checkbox"]) , .order_item_group span:nth-child(2) {
        width: 60%;
    }
    .order_product_list {
        width: 100%;
