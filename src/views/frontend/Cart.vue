<template>
  <div class="Cart">
    ...
    <div class="container wrapper">
      ...
      <div v-if="list.length === 0" class="cart_empty_block">
        <div class="header"></div>
        <div class="body">
          購物車目前是空的唷，歡迎到<router-link
            class="shop_link"
            to="/shop/all"
            >購物商城</router-link
          >繼續選購。
      ...
      <div v-else>
              ...
              <tr v-for="item in list" :key="item.id">
                ...
                <td>
                  <div class="product_qty">
                    <button @click="updateCartItemQty(item, item.qty - 1)">
                      -
                    </button>
                    <input
                      @blur="updateCartItemQty(item, item.qty)"
                      min="1"
                      max="99"
                      type="number"
        ...
        <div class="cart_total">
          <div class="coupon_container">
            ...
            <a
              ...
              >部分已套用優惠券</a
            >
            <a class="coupon_yes" v-else @click.prevent="useCoupon" href="#"
              >已套用優惠券</a
            >
          </div>
          <div class="total_num">
        ...
        <div class="go_checkout">
          <router-link v-if="list.length > 0" to="/checkout"
            >前往填寫資料</router-link
          >
        </div>
      </div>
...
.cart_empty_block .header {
  background: #f7f7f7;
  border: 1px solid #e9e9e9;
  border-bottom: 0;
  height: 45px;
}
.cart_empty_block .body {
  border: 1px solid #e9e9e9;
  padding: 20px;
  letter-spacing: 1px;
}
.cart_empty_block .body .shop_link {
  color: #fe5252;
