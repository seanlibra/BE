<template>
  <div class="header_tools_container">
    <h1>優惠券列表</h1>
    <div class="tools">
      <a class="add_coupon" href="#" @click.prevent="openModal(true)"
        >新增優惠券</a
      >
      <a class="del_all_coupon" @click.prevent="openDelModal(true)" href="#"
        >刪除所有優惠券</a
      >
    </div>
  </div>
  ...
  <nav aria-label="Page navigation example" class="mt-3">
    <ul class="pagination justify-content-center custom_pagination">
      ...
      <li
        ...
        class="page-item"
      >
        <a @click.prevent="getCoupons(index + 1)" class="page-link" href="#">{{
          index + 1
        }}</a>
      </li>
